        ...
        if (replace && results.length === 0) {
            resultsDiv.innerHTML = `
                <div class="flex flex-col items-center justify-center h-full text-center space-y-6 py-12">
                    ...
                    <button onclick="setSearchMode('ia'); document.getElementById('unified-input').value = '" + escapeHtml(_searchState.query) + "'; setTimeout(function() { dispatchUnifiedSearch(); }, 100);" 
